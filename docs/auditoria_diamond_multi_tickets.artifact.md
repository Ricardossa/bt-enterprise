...
Implementado `Database::beginImmediate()` para garantir que o SQLite bloqueie o banco no momento da seleção da senha. Isso elimina o risco de dois operadores chamarem o mesmo `device_id` simultaneamente.

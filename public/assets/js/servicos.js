...
BT.servicos = {
    ...
    async salvar(metodo) {
        ...
        const dados = {
            ...
            slug: document.getElementById('modal_slug').value.trim(),
        ...
        return `
            <form id="formServicoModal" autocomplete="off" onsubmit="return false;">
                ...
                <div class="form-group mb-3">
                    <label for="modal_codigo" class="form-label font-weight-bold">Código</label>
                    <input type="text" id="modal_codigo" class="form-control" value="${dados.codigo || ''}" required>
                </div>

                <div class="form-group mb-3">
                    <label for="modal_nome" class="form-label font-weight-bold">Nome</label>
                    <input type="text" id="modal_nome" class="form-control" value="${dados.nome || ''}" required>
                </div>

                <div class="form-group mb-3">
                    <label for="modal_slug" class="form-label font-weight-bold">Slug (URL)</label>
                    <input type="text" id="modal_slug" class="form-control" value="${dados.slug || ''}" required>
                </div>

                <div class="form-group mb-3">
                    <label for="modal_prefixo" class="form-label font-weight-bold">Prefixo</label>
                    <input type="text" id="modal_prefixo" class="form-control" value="${dados.prefixo || ''}" required maxlength="3">
                </div>

                <div class="form-group mb-3">
                    <label for="modal_icone" class="form-label">Ícone (Emoji)</label>
                    <input type="text" id="modal_icone" class="form-control" value="${dados.icone || '📋'}">
                </div>

                <div class="form-group mb-3">
                    <label for="modal_cor" class="form-label">Cor</label>
                    <input type="color" id="modal_cor" class="form-control form-control-color w-100" value="${dados.cor || '#1565C0'}">
                </div>

                <div class="form-group mb-3">
                    <label for="modal_ordem" class="form-label">Ordem de Exibição</label>
                    <input type="number" id="modal_ordem" class="form-control" value="${dados.ordem !== undefined ? dados.ordem : 0}" min="0">
                </div>

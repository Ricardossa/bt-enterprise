    ...
    <div class="bt-grid" style="grid-template-columns: 1.5fr 1fr;">
        <section class="noc-card">
            ...
            <div class="noc-timeline" id="timeline">
                ...
                <div class="noc-item">
                    <div class="noc-time"><?= date('H:i:s', strtotime($act['data_criacao'])) ?></div>
                    <div class="noc-msg">
                        <?php
        ...
        <aside class="noc-card">
            ...
            <div style="display:flex; flex-direction:column; gap:12px;">
                <a href="operador.php" class="bt-button bt-primary" style="text-decoration:none; text-align:center;">
                    <i class="fa-solid fa-headset"></i> Abrir Painel Operador
                </a>

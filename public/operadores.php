...
<main class="bt-main">
    ...
    <div style="display:flex; justify-content:space-between; align-items:center;">
        <div>
            <h2><i class="fa-solid fa-user-tie"></i> Equipe de Operadores</h2>
            <p style="color:var(--text2); font-size:14px;">Gerencie quem opera cada mesa e serviço do sistema.</p>
        </div>
        <button id="btnNovo" class="bt-button bt-primary">
            <i class="fa-solid fa-plus"></i> Novo Operador
        </button>
    </div>
